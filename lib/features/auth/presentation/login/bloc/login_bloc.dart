...
import 'package:socially_app/features/auth/domain/use_cases/validate_password_use_case.dart';
import 'package:socially_app/features/auth/domain/use_cases/validate_user_name_use_case.dart';
...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  _mapChangeUserName(ChangeUserNameEvent event, Emitter<LoginState> emit) async {
    ...
    emit(state.copyWith(emailValidationMessage: result, userName: event.userName));
  }
